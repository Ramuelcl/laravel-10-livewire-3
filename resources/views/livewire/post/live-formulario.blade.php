        ...
        <x-slot name="content">
            <form class="border-b-4">
                <fieldset {{ $ventana === 3 ? 'disabled' : '' }}>
                    ...
                    <div class="flex justify-between gap-4">
                        ...
                        <div class="mb-4 w-1/2">
                            ...
                            <x-select2 :multiple="true" class="w-full" wire:model="selectedMarcadores">
                ...
                <div class="flex justify-end border-t-4">
                    ...
                    <x-primary-button color="red" wire:click="fncSave({{ $ventana === 1 ? 0 : $post->id }})">{{ $ventana === 1 ? 'Crear' : ($ventana === 2 ? 'Editar' : 'Eliminar') }}</x-primary-button>
                </div>
            </form>
        </x-slot>
