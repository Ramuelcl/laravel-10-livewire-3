    ...
    <div class="flex divide-x-4 justify-between mx-10">
        <div class="my-4">
            <div class="text-center md:text-left">
                <span class="font-bold">Total importados:</span> <span
                    class="font-bold">{{ $totalImportados ?? null }}</span>
            </div>
        </div>
        <div class="my-4">
            <div class="text-center md:text-left">
                <span class="font-bold">Registros duplicados:</span> <span
                    class="font-bold">{{ $totalDuplicados ?? null }}</span>
            </div>
            @isset($totalDuplicados)
            ...
            <div class="my-4">
                <div class="text-center md:text-left">
                    <span class="font-bold">Total movimientos:</span> <span
                        class="font-bold">{{ $totalMovimientos ?? null }}</span>
                </div>
        ...
        @if ($data)
            {{-- @livewire('live-tabla', ['data' => $data, ['encabezado' => 'Datos Transferidos', 'titulos' => $titulos, 'campos' => $campos]]) --}}
        @endif
