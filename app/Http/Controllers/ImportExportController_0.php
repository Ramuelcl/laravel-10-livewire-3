...
use App\Models\backend\{Ciudad, Direccion, Entidad, Pais, Telefono};
...
class ImportExportController extends Controller
{
    ...
    public function showImportForm()
    {
        ...
        $campos = ['id', 'date', 'libelle', 'montantEUROS', 'montantFRANCS', 'NomArchTras', 'idMovimientos'];
        $totalImportados = Traspaso::count();
        $totalMovimientos = Traspaso::whereNotNull('idMovimientos')->count();
    ...
    {
        // Obtener los registros sin idMovimientos de la tabla traspasos
        try {
            $registros = Traspaso::whereNull('idMovimientos')->get();
            if ($registros) {
                foreach ($registros as $registro) {
                    ...
                    try {
                        ...
                        // dd($idMovimiento);
                        // Actualizar el campo idMovimientos en la tabla traspasos
                        $registro->idMovimientos = $idMovimiento;
                        $registro->save();
                    } catch (\Throwable $e) {
                        // Manejar el error
